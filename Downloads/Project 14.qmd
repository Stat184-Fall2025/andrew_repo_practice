...
raw_headers <- read_sheet(
  ss = 
    "https://docs.google.com/spreadsheets/d/19xQnI1cBh6Jkw7eP8YQuuicMlVDF7Gr-nXCb5qbwb_E/edit?usp=sharing",
  col_names = FALSE,
  n_max = 3
)
...
# Plugging volume function into omptimization
max <- optimize(vol_calc, c(0, (PAPERLEN/2)), maximum=TRUE)
print(max)

# Goal 2: Use plot() to create data visualization showing the 
# relationship between cut and volume
